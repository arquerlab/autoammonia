...
class TestAddExperimentToDb:
    ...
    def test_add_experiment_with_valid_data(self, temp_db, test_precursors_and_electrolytes):
        """Test adding an experiment with valid precursors and electrolytes."""
        session = temp_db()
        
        # Precursors and electrolytes are already created by test_precursors_and_electrolytes fixture
    ...
    def test_add_experiment_without_notes_or_metadata(self, temp_db, test_precursors_and_electrolytes):
    ...
    def test_add_experiment_raises_error_for_missing_precursor(self, temp_db, test_precursors_and_electrolytes):
        """Test that ValueError is raised when precursor is not found."""
        session = temp_db()
        
        # Electrolytes are already created by fixture, but we'll test with a non-existent precursor
    ...
    def test_add_experiment_raises_error_for_missing_electrolyte(self, temp_db, test_precursors_and_electrolytes):
        """Test that ValueError is raised when electrolyte is not found."""
        session = temp_db()
        
        # Precursors are already created by fixture, but we'll test with a non-existent electrolyte
    ...
    def test_add_experiment_proportions_are_stored_correctly(self, temp_db, test_precursors_and_electrolytes):
